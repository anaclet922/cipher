...
class EditCipher extends StatelessWidget {

  CipherModel cipher;

  EditCipher({Key? key, required this.cipher}) : super(key: key);

  final viewModel = Get.put(CipherViewModel());

  @override
  Widget build(BuildContext context) {
    viewModel.cipherNameController.value.text = cipher.name;
    viewModel.cipherCipherController.value.text = cipher.cipher;
    return  Column(
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  viewModel.saveEditedCipher(cipher.id, 'cipher');
