...
import 'package:cipher_saver/screens/edit_keyword.dart';
...
class KeywordItem extends StatelessWidget {
  ...
  final int listIndex;
  final String type;
  KeywordItem({super.key, required this.keyword, required this.listIndex, required this.type});
  //
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
              onTap: (){
                Get.to(MainLayout(pageContent: EditKeyword(keyword: keyword)));
                viewModel.btnPressedSound();
              },
              child: Text(keyword.name, style: const TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w700),)
          ),
          GestureDetector(
            onTap: (){
              Get.dialog(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        viewModel.deleteCipher(keyword.id, listIndex, type);
